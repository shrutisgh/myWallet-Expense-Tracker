            ...
            <ThemeContext.Provider value={{ isDarkMode, toggleTheme }}>
                <RoutesWrapper isDarkMode={isDarkMode}>
                    <Routes>
                        ...
                        {/* User routes */}
                        <Route element={<ProtectedRoute isAllowed={currentUser && currentUser.roles.includes("ROLE_USER")} />}>
                        ...
                        {/* Admin routes */}
                        <Route element={<ProtectedRoute isAllowed={currentUser && currentUser.roles.includes("ROLE_ADMIN")} />}>
